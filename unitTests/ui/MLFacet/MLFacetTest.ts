...
export function MLFacetTest() {
  describe('MLFacet', () => {
    ...
    it('should have a default title', () => {
      ...
      expect($$(test.cmp.element).find('.coveo-ml-facet-header-title').innerHTML).toBe('No title');
    });
    ...
    it('title option should set the title', () => {
      ...
      expect($$(test.cmp.element).find('.coveo-ml-facet-header-title').innerHTML).toBe(options.title);
    });
