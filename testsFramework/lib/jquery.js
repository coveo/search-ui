/**
 * Created by olamothe on 2016-05-16.
 */
 ...
 */ (function(e, t) {
  var n,
    ...
    q = function() {
      o.addEventListener
        ...
        : (o.off('onreadystatechange', H), e.detachEvent('onload', H));
    };
  (b.fn = b.prototype = {
    jquery: p,
    constructor: b,
    ...
    (b.ready.promise = function(t) {
      if (!n)
        if (((n = b.Deferred()), 'complete' === o.readyState)) setTimeout(b.ready);
          ...
          o.on('onreadystatechange', H), e.attachEvent('onload', H);
          var r = !1;
          try {
  ...
  function M(e) {
    ...
    return b.isWindow(e)
      ? !1
      : 1 === e.nodeType && t ? !0 : 'array' === n || ('function' !== n && (0 === t || ('number' == typeof t && t > 0 && t - 1 in e)));
  }
  r = b(o);
  var _ = {};
  function F(e) {
      ...
      if (s[u]) {
        if (t && (o = n ? s[u] : s[u].data)) {
          b.isArray(t)
            ...
            : t in o ? (t = [t]) : ((t = b.camelCase(t)), (t = t in o ? [t] : t.split(' ')));
          ...
          return typeof e.getAttribute === i
            ...
            : ((a = 1 !== u || !b.isXMLDoc(e)),
              ...
              r === t
                ...
                : null !== r
                  ? o && a && 'set' in o && (s = o.set(e, r, n)) !== t ? s : (e.setAttribute(n, r + ''), r)
                  : (b.removeAttr(e, n), t));
      },
    ...
    (z = {
      ...
      set: function(e, t, n) {
        return (
          t === !1
            ? b.removeAttr(e, n)
            : (K && Q) || !G.test(n) ? e.setAttribute((!Q && b.propFix[n]) || n, n) : (e[b.camelCase('default-' + n)] = e[n] = !0),
          n
        );
      }
    }),
  ...
  (b.event = {
          ...
          (s = rt.exec(n[l]) || []),
            ...
            (h = u[g]) ||
              ...
              (p.setup && p.setup.call(e, o, m, f) !== !1) ||
                (e.addEventListener ? e.addEventListener(g, f, !1) : e.on && e.on('on' + g, f))),
    ...
    (b.removeEvent = o.removeEventListener
      ...
      : function(e, t, n) {
          var r = 'on' + t;
          e.off && (typeof e[r] === i && (e[r] = null), e.off(r, n));
        }),
        ...
        (st.attr = function(e, t) {
          ...
          return (
            ...
            (n = i.attrHandle[t])
              ...
              : d || T.attributes
                ? e.getAttribute(t)
                : ((n = e.getAttributeNode(t)) || e.getAttribute(t)) && e[t] === !0 ? t : n && n.specified ? n.value : null
          );
        }),
        (st.error = function(e) {
  ...
  b.fn.extend({
    ...
    is: function(e) {
      return (
        !!e &&
        ('string' == typeof e
          ? lt.test(e) ? b(e, this.context).index(this[0]) >= 0 : b.filter(e, this).length > 0
    ...
    index: function(e) {
      return e
        ? 'string' == typeof e ? b.inArray(this[0], b(e)) : b.inArray(e.jquery ? e[0] : e, this)
  ...
  b.each({ appendTo: 'append', prependTo: 'prepend', insertBefore: 'before', insertAfter: 'after', replaceAll: 'replaceWith' }, function(
    e,
    t
  ) {
    b.fn[e] = function(e) {
          ...
          2 !== x &&
            ...
            (e >= 200 && 300 > e) || 304 === e
              ? (p.ifModified &&
                ...
                204 === e
                  ? ((c = !0), (C = 'nocontent'))
                  : 304 === e ? ((c = !0), (C = 'notmodified')) : ((c = Fn(p, w)), (C = c.state), (y = c.data), (v = c.error), (c = !v)))
  ...
  b.each(
    ...
    (b.speed = function(e, t, n) {
      ...
      return (
        (r.duration = b.fx.off
          ? 0
          : 'number' == typeof r.duration ? r.duration : r.duration in b.fx.speeds ? b.fx.speeds[r.duration] : b.fx.speeds._default),
