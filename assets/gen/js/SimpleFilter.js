...
var SimpleFilter = /** @class */ (function (_super) {
    ...
    function SimpleFilter(element, options, bindings) {
        ...
        _this.bind.onRootElement(QueryEvents_1.QueryEvents.querySuccess, function (args) { return _this.handleGroupBy(args); });
        return _this;
    }
    /**
    ...
    SimpleFilter.prototype.handleGroupBy = function (data) {
    ...
    SimpleFilter.prototype.getDisplayedTitle = function () {
    ...
    SimpleFilter.prototype.getBackdrop = function () {
