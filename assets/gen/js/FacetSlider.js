...
Object.defineProperty(exports, "__esModule", { value: true });
var Slider_1 = __webpack_require__(487);
var Component_1 = __webpack_require__(8);
var ComponentOptions_1 = __webpack_require__(9);
var FacetHeader_1 = __webpack_require__(419);
var Strings_1 = __webpack_require__(10);
var InitializationEvents_1 = __webpack_require__(17);
var FacetSliderQueryController_1 = __webpack_require__(489);
...
var ResponsiveFacetSlider_1 = __webpack_require__(490);
__webpack_require__(491);
var MiscModules_1 = __webpack_require__(60);
...
var FacetSlider = /** @class */ (function (_super) {
    ...
    function FacetSlider(element, options, bindings, slider) {
        ...
        if (_this.options.start) {
            _this.options.start = _this.options.dateField
                ? new Date(_this.options.start.replace(/-/g, '/')).getTime()
                : Number(_this.options.start);
        }
        if (_this.options.end) {
            _this.options.end = _this.options.dateField
                ? new Date(_this.options.end.replace(/-/g, '/')).getTime()
                : Number(_this.options.end);
        }
...
var d3_time = __webpack_require__(243);
...
var d3_collection = __webpack_require__(92);
...
var d3_format = __webpack_require__(269);
...
var d3_time_format = __webpack_require__(270);
  ...
  function tickInterval(interval, start, stop, step) {
    ...
    if (typeof interval === "number") {
      ...
      if (i === tickIntervals.length) {
        ...
        step = Object(d3_array["A" /* tickStep */])(start, stop, interval);
...
var SliderEvents_1 = __webpack_require__(101);
var Utils_1 = __webpack_require__(6);
var d3_scale_1 = __webpack_require__(435);
var d3_1 = __webpack_require__(488);
...
var d3_scale = __webpack_require__(435);
...
var FacetSliderQueryController = /** @class */ (function () {
    ...
    FacetSliderQueryController.prototype.handleQuerySuccess = function (args) {
        ...
        if (!this.isAValidRangeResponse(args)) {
            ...
            logger.error("Cannot instantiate FacetSlider for this field : " + this.facet.options
