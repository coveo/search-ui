...
var DefaultQuickviewTemplate_1 = __webpack_require__(973);
var ResultListEvents_1 = __webpack_require__(35);
var StringUtils_1 = __webpack_require__(21);
var QuickviewDocument_1 = __webpack_require__(974);
...
var Quickview = (function (_super) {
    ...
    Quickview.prototype.createModalBox = function (openerObject) {
        ...
        return openerObject.content.then(function (builtContent) {
            ...
            _this.modalbox = _this.ModalBox.open(computedModalBoxContent.el, {
                title: DomUtils_1.DomUtils.getQuickviewHeader(_this.result, {
                    showDate: _this.options.showDate,
                    title: _this.options.title
                }, _this.bindings).el.outerHTML,
    ...
    Quickview.prototype.setQuickviewSize = function () {
        var wrapper = Dom_1.$$(Dom_1.$$(this.modalbox.modalBox).find('.coveo-modal-content'));
