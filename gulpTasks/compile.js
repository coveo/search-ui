...
gulp.task('executeWebpack', ['addEolDependencies', 'deprecatedDependencies', 'prepareSass'], shell.task([
...
gulp.task('duplicateCssFile', () => {
  gulp.src('./bin/css/CoveoFullSearch.css')
    .pipe(rename('CoveoFullSearchNewDesign.css'))
    .pipe(gulp.dest('./bin/css'));
});

gulp.task('duplicateCssMapFile', () => {
  gulp.src('./bin/css/CoveoFullSearch.css.map')
