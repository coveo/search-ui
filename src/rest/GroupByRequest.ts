 ...
 *
 * See [Group By Parameters](https://docs.coveo.com/en/1453/).
 */
export interface IGroupByRequest {
   ...
   * Group By value (see [Computed Field Parameters](https://docs.coveo.com/en/1467/)).
   ...
   * [Computed Field Parameters](https://docs.coveo.com/en/1467/).
   */
