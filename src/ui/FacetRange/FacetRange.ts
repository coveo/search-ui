...
/**
 * Renders a facet whose values are expressed as ranges.
 *
 * You must specify a valid [`field`]{@link Facet.options.field} value for this component to work. This value must target a numeric or date field in your index.
 *
 * This component extends the [`Facet`]{@link Facet} component. As such, the `FacetRange` supports all `Facet` options except:
 *
...
export class FacetRange extends Facet implements IComponentBindings {
  ...
  static options: IFacetRangeOptions = {
    /**
     * Whether the specified [`field`]{@link Facet.options.field} value targets a date field in your index.
     *
     * This allows the component to correctly build the outgoing [Group By request]{@link IGroupByRequest}.
     *
     * **Default:** `false`.
     */
