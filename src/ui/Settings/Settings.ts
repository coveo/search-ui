  ...
  export class Settings extends Component {
    ...
    private buildMenu(): HTMLElement {
      ...
      _.each(settingsPopulateMenuArgs.menuData, (menuItem) => {
        var menuItemDom = $$('div', {className: `coveo-settings-item ${menuItem.className}`, title: _.escape(menuItem.tooltip || '')}).el;
    ...
    private getPopupPositioning(): PopupUtils.Position {
      return {
        horizontal: PopupUtils.HorizontalAlignment.INNERRIGHT,
        vertical: PopupUtils.VerticalAlignment.BOTTOM,
        verticalOffset: 8
      }
    }
  }
