...
export class SimpleFilter extends Component {
  ...
  /**
   * An array containing the checkboxes and their labels used in the `SimpleFilter` component.
   */
  ...
  /**
   * Toggles the `SimpleFilter` between its opened and closed state.
   */
  public toggle() {
  ...
  public handleGroupBy(data: IQuerySuccessEventArgs) {
