...
export class Folding extends Component {
  ...
  static options: IFoldingOptions = {
     ...
     * `@myfield descending`, etc.). For more information, see [Query Parameters - sortCriteria](https://developers.coveo.com/x/iwEv#QueryParameters-sortCriteriasortCriteria).
     *
     * This option works from the results returned from the index. This means that if only the three most relevant folded results are returned by the index 
