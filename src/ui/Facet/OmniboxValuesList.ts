...
module Coveo {
  export class OmniboxValuesList {
    constructor(public facet: Facet, public facetValues: FacetValue[], public omniboxObject: PopulateOmniboxObject, public omniboxValueElementKlass: OmniboxValueElementKlass) {
    }
    ...
    private buildOmniboxForOneRow(facetValue: FacetValue, omniboxObject: PopulateOmniboxObject): HTMLElement {
    ...
    private omniboxCloseEvent(eventArg: PopulateOmniboxObject) {
