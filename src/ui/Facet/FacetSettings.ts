...
module Coveo {
  ...
  export class FacetSettings extends FacetSort {
    ...
    private getPopupAlignment() {
      var alignmentHorizontal = DeviceUtils.isMobileDevice() ? JQueryUtils.HorizontalAlignment.center : JQueryUtils.HorizontalAlignment.innerLeft;
      var alignmentVertical = JQueryUtils.VerticalAlignment.bottom;
      return {
