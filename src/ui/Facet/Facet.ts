...
module Coveo {
  ...
  export class Facet extends Component {
    ...
    static options: IFacetOptions = {
       ...
       */
      title: ComponentOptions.buildLocalizedStringOption({defaultValue: l('NoTitle'), section:'Identification', priority : 10}),
      /**
    ...
    protected processNewGroupByResults(groupByResult: GroupByResult) {
    ...
    private triggerUpdateDeltaQuery(facetValues: FacetValue[]): void {
      ...
      this.facetQueryController.searchInFacetToUpdateDelta(facetValues).then((queryResults?) => {
        ...
        _.each(queryResults.groupByResults, (groupByResult: GroupByResult) => {
