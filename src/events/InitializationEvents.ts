/**
 * This static class is there to contains the different string definitions for all the events related to initialization.
 *
...
export class InitializationEvents {
   ...
   *
   * It is triggered *before* the first query is launched, if the {@link SearchInterface.options.autoTriggerQuery} is `true`.
   *
   ...
   *
   * After this event has been executed, the search interface can be dynamically removed and all handlers cleanly removed.
   *
